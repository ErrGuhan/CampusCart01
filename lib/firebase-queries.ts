...
export const DEFAULT_GIGS: ServiceGig[] = [
  {
    id: 'gig-poster-design',
    sellerId: 'seller-guhan',
    seller: DEFAULT_SELLERS[0],
    title: 'Custom Event Poster & Social Media Banner Design',
    slug: 'custom-event-poster-design',
    description: 'High-resolution Photoshop and Canva poster design for college club symposiums, cultural fests, workshops, and technical webinars.',
    category: 'Design & Posters',
    startingPrice: 199,
    deliveryTimeDays: 1,
    revisions: 3,
    tags: ['Poster', 'Photoshop', 'Canva', 'Symposium', 'Club Banner'],
    coverImage: 'https://images.pexels.com/photos/1047540/pexels-photo-1047540.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    rating: 4.9,
    reviewCount: 14,
    isVerified: true,
    status: 'active',
  ...
  },
  {
    ...
    sellerId: 'seller-guhan',
    seller: DEFAULT_SELLERS[0],
    title: 'Python, Flask & Arduino IoT Mini Project Assistance',
    slug: 'python-flask-arduino-iot-mini-project',
    description: 'Hands-on debugging and development for mini projects involving Python, Node.js, Arduino UNO, ESP32 Wi-Fi sensors, and Firebase dashboards.',
    category: 'Coding & Tech Projects',
    startingPrice: 349,
    deliveryTimeDays: 2,
    revisions: 2,
    tags: ['Python', 'Arduino', 'IoT', 'Flask', 'ESP32', 'Mini Project'],
    coverImage: 'https://images.pexels.com/photos/2582937/pexels-photo-2582937.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    rating: 5.0,
    reviewCount: 22,
    isVerified: true,
    status: 'active',
  ...
  },
  {
    ...
    sellerId: 'seller-guhan',
    seller: DEFAULT_SELLERS[0],
    title: 'AutoCAD 2D Floor Plans & SolidWorks 3D Modeling',
    slug: 'autocad-2d-solidworks-3d-modeling',
    description: 'Precise engineering blueprints, machine component drafting in AutoCAD, and 3D STL file prep ready for 3D printing or lab submissions.',
    category: '3D Printing & CAD',
    startingPrice: 249,
    deliveryTimeDays: 2,
    revisions: 2,
    tags: ['AutoCAD', 'SolidWorks', 'CAD', '3D Printing', 'Mechanical'],
    coverImage: 'https://images.pexels.com/photos/3862632/pexels-photo-3862632.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    rating: 4.8,
    reviewCount: 9,
    isVerified: true,
    status: 'active',
  ...
  },
  {
    ...
    sellerId: 'seller-guhan',
    seller: DEFAULT_SELLERS[0],
    title: 'Cinematic Reel & After-Movie Video Editing for Fests',
    slug: 'cinematic-reel-after-movie-editing',
    description: 'Fast-paced Instagram reels, YouTube video edits, color grading, sound design, and motion graphics with Premiere Pro & DaVinci Resolve.',
    category: 'Video & Photography',
    startingPrice: 299,
    deliveryTimeDays: 1,
    revisions: 3,
    tags: ['Video Editing', 'Premiere Pro', 'Reels', 'Campus Fest', 'AfterMovie'],
    coverImage: 'https://images.pexels.com/photos/257904/pexels-photo-257904.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    rating: 4.9,
    reviewCount: 17,
    isVerified: true,
    status: 'active',
  ...
  },
  {
    ...
    sellerId: 'seller-guhan',
    seller: DEFAULT_SELLERS[0],
    title: 'ATS Resume Formatting & Placement Profile Polish',
    slug: 'ats-resume-formatting-placement-polish',
    description: 'Clean LaTeX/Word ATS-friendly tech resumes, GitHub README profiles, and LinkedIn optimization for campus placement drives.',
    category: 'Writing & Resumes',
    startingPrice: 149,
    deliveryTimeDays: 1,
    revisions: 2,
    tags: ['Resume', 'ATS', 'Placements', 'LaTeX', 'LinkedIn', 'Career'],
    coverImage: 'https://images.pexels.com/photos/590016/pexels-photo-590016.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    rating: 5.0,
    reviewCount: 31,
    isVerified: true,
    status: 'active',
...
export const DEFAULT_GIG_REQUESTS: GigRequest[] = [
  {
    id: 'bounty-techfest-logo',
    requesterId: 'student-priya',
    requesterName: 'Priya R',
    requesterEmail: 'priya.ece@svcet.ac.in',
    title: 'Urgent: Symposium Logo & Poster for ECE TechFest 2026',
    description: 'Need a modern vector logo, Instagram poster set, and badge design for our upcoming department symposium within 48 hours.',
    category: 'Design & Posters',
    budget: 450,
    deadlineDays: 2,
    status: 'open',
  ...
  },
  {
    ...
    requesterEmail: 'rahul.mech@svcet.ac.in',
    title: 'Help integrating ESP32 with DHT22 & MQTT for Final Year Project',
    description: 'Looking for a classmate experienced in ESP32 coding to help wire up sensor calibration and send telemetry to cloud MQTT broker.',
    category: 'Coding & Tech Projects',
    budget: 500,
    deadlineDays: 3,
    status: 'open',
...
export const DEFAULT_REQUESTS: ProductRequest[] = [
  {
    ...
    requesterId: 'student-priya',
    requesterName: 'Priya R',
    requesterUsername: 'priya_ece',
    requesterAvatar: 'https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=300',
    requesterDepartment: 'ECE Department',
    requesterYear: '1st Year',
    title: 'Urgent: Mini Drafter + Drawing Sheet Holder for EG Lab',
    description: 'Looking for a gently used mini drafter in good condition with unbroken scales and a sheet container for upcoming graphics exam.',
    category: 'Stationery',
    budget: 350,
    deadlineDate: 'Within 2 days',
    status: 'open',
    offersCount: 2,
    ...
    offers: [
      {
        id: 'off-drafter-1',
        requestId: 'req-mini-drafter',
        sellerId: 'seller-guhan',
        sellerName: 'Guhan M',
        sellerUsername: 'guhan',
        sellerAvatar: 'https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=300',
        price: 320,
        message: 'I have an Omega mini drafter with steel rod in perfect condition. Can handover near CSE block.',
        condition: 'like_new',
        status: 'pending',
        createdAt: '2024-02-15T00:00:00Z',
      },
  ...
  {
    id: 'req-calculator-991ex',
    requesterId: 'student-rahul',
    requesterName: 'Rahul K',
    requesterUsername: 'rahul_mech',
    requesterAvatar: 'https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=300',
    requesterDepartment: 'Mechanical Engineering',
    requesterYear: '2nd Year',
    title: 'Looking for Casio FX-991EX Scientific Calculator',
    description: 'Need a functional ClassWiz fx-991ex or fx-991ms calculator for Thermodynamics and Math exams.',
  ...
  },
  {
    ...
    requesterUsername: 'ananya_cse',
    requesterAvatar: 'https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&w=300',
    requesterDepartment: 'Computer Science & Engineering',
    requesterYear: '2nd Year',
    title: 'Handwritten Notes for Operating Systems & DBMS Lab Records',
    description: 'Need clean handwritten or compiled revision material covering OS CPU scheduling algorithms & SQL lab queries.',
    category: 'Books',
    budget: 180,
    deadlineDate: 'Urgent (Today)',
    status: 'open',
    offersCount: 3,
  ...
  {
    id: 'req-arduino-sensors',
    requesterId: 'student-karthik',
    requesterName: 'Karthik V',
    requesterUsername: 'karthik_eee',
    requesterAvatar: 'https://images.pexels.com/photos/91227/pexels-photo-91227.jpeg?auto=compress&cs=tinysrgb&w=300',
    requesterDepartment: 'Electrical & Electronics',
    requesterYear: '3rd Year',
    title: 'Arduino UNO R3 Starter Kit + Ultrasonic Sensors',
    description: 'Required for mini project obstacle detection car. Jumper wires and breadboard needed as well.',
    category: 'Electronics',
    budget: 450,
    deadlineDate: 'Within 5 days',
    status: 'open',
    offersCount: 1,
    createdAt: '2024-02-18T00:00:00Z',
    offers: [],
...
export const DEFAULT_COMMUNITY_POSTS: CommunityPost[] = [
  {
    ...
    title: 'Smart India Hackathon 2026: Team Formation & Hardware Project Ideas',
    content: 'Hey everyone! We are organizing project groups for SIH 2026. If you have experience in IoT, React, or Python and want to brainstorm problem statements, drop a comment or connect!',
    tags: ['SIH2026', 'Hackathon', 'IoT', 'TeamUp', 'CSE'],
    likes: 18,
    likedBy: [],
    commentsCount: 6,
    createdAt: '2024-02-17T00:00:00Z',
  },
  {
    ...
    authorName: 'Priya R',
    authorUsername: 'priya_ece',
    authorAvatar: 'https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=300',
    authorDepartment: 'ECE Department',
    category: 'academic',
    title: 'Advice for 1st Year Engineering Graphics & Drawing Labs',
    content: 'A quick tip for juniors: Always ensure your mini drafter clamp screws are tightened before aligning with the drawing board border. Saves 15-20 minutes in mid-term drafting exams!',
    tags: ['1stYear', 'EngineeringGraphics', 'ExamTips', 'Drafter'],
    likes: 24,
    likedBy: [],
    commentsCount: 4,
    createdAt: '2024-02-18T00:00:00Z',
  ...
  {
    id: 'post-project-expo',
    authorId: 'student-karthik',
    authorName: 'Karthik V',
    authorUsername: 'karthik_eee',
    authorAvatar: 'https://images.pexels.com/photos/91227/pexels-photo-91227.jpeg?auto=compress&cs=tinysrgb&w=300',
    authorDepartment: 'Electrical & Electronics',
    category: 'clubs',
    title: 'Annual Campus Project Expo & Robotics Arena Registration Open',
    content: 'Registration is now open for the campus robotics obstacle challenge and hardware showcase. Certificate of merit and cash prizes for top 3 teams in each category.',
    tags: ['Robotics', 'ProjectExpo', 'TechFest', 'CollegeClubs'],
    likes: 15,
    likedBy: [],
    commentsCount: 2,
    createdAt: '2024-02-19T00:00:00Z',
