    ...
    >
      ...
      <div className="relative aspect-square w-full overflow-hidden shimmer-placeholder select-none">
        ...
        <button
          ...
          className="absolute top-2.5 right-2.5 flex h-8.5 w-8.5 sm:h-9 sm:w-9 items-center justify-center rounded-full bg-card/90 dark:bg-card/90 text-foreground/80 shadow-xs backdrop-blur-md transition-all hover:text-destructive hover:scale-110 active:scale-90 z-10 border border-border/70"
        >
