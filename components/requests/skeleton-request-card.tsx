...
export function SkeletonRequestCard({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        'p-5 sm:p-6 rounded-3xl border border-border/70 bg-card shadow-xs animate-pulse flex flex-col gap-4 select-none',
        className
      )}
    >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="h-3.5 w-36 bg-secondary/70 rounded-md" />
            </div>
            {/* Year & Date */}
            <div className="h-3 w-24 bg-secondary/60 rounded-md" />
          </div>
        </div>
      ...
      <div className="space-y-2.5 my-1">
        {/* Title */}
        <div className="h-5 w-4/5 bg-secondary/90 rounded-lg" />
      ...
      <div className="pt-3 border-t border-border/50 flex items-center justify-between gap-2">
        ...
        <div className="h-9 w-36 bg-secondary/80 rounded-xl" />
      </div>
    </div>
  );
}
